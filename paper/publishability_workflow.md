...
- Done: facet ICOT pipeline, KB (~1820 docs), Streamlit demo, protocol, ChatIoT-style baseline, **full 50-Q four-way** (`full_four_way.json`), Methods/Results drafts updated.
